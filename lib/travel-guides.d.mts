...
export function searchTravelGuides(city: string, env?: NodeJS.ProcessEnv, fetcher?: typeof fetch): Promise<{ sources: InternalGuideSource[]; state: 'live' | 'pending'; warning: string | null }>;
