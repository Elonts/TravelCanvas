export type Stop = { id: string; time: string; name: string; address: string; detail: string; duration: string; cost: number; indoor: boolean; lng: number; lat: number; verified: boolean };
