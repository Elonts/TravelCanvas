...
export type Day = { title: string; city: string; date: string; stops: Stop[]; startHotel?: BookedHotel | null; arrivalHotel?: BookedHotel | null; endHotel?: BookedHotel | null; startHub?: TravelHub | null; endHub?: TravelHub | null; availableFrom?: string; mustFinishBy?: string; arrivalHotelTime?: string; endHotelTime?: string; scheduleIssues?: string[]; warning?: string };
